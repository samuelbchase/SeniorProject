...
\begin{document}
	...
	\begin{proof}
		...
		Therefore the change in $T$ cannot be less than zero, and thus $T$ will not be decreased and $T$ will be able to complete the spanning tree.
		\par
